  ...
  return (
    <>
      <Box className="onboardContainer">
        <Typography mb={1} className="boldFont poppinsBold"
          sx={{ fontWeight: "bolder", textAlign: "center" }}
          variant="h5"
        >Process of Onboarding</Typography>
        <Typography mb={5} sx={{ fontSize: "13px", textAlign: "center" }} className='poppins'>Lorem ipsum dolor sit amet consectetur. Nulla sed turpis adipiscing mauris sit morbi potenti mauris.</Typography>
        <Box className="stepBox">
          ...
          <Box m={3} className="stepItem">
            ...
            <Typography className='poppins' mb={1} sx={{ color: "#359CEF", fontWeight: "700", fontSize: "11px" }}>STEPS 1</Typography>
            <Typography className='poppins' sx={{ textAlign: "center", fontWeight: "700" }}>Register for <br /> NaukriSaksham</Typography>
          </Box>
          <Box m={3} className="stepItem">
            <Box className="stepItemLOgo">
            ...
            <Typography className='poppins' mb={1} sx={{ color: "#CF2323", fontWeight: "700", fontSize: "11px" }}>STEPS 2</Typography>
            <Typography className='poppins' sx={{ textAlign: "center", fontWeight: "700" }}>Deposit 100% Refundable<br /> deposit: Rs. 6900/-</Typography>
          </Box>
          <Box m={3} className="stepItem">
            <Box className="stepItemLOgo">
            ...
            <Typography className='poppins' mb={1} sx={{ color: "#8C29CC", fontWeight: "700", fontSize: "11px" }}>STEPS 3</Typography>
            <Typography className='poppins' sx={{ textAlign: "center", fontWeight: "700" }}>Get all above Program<br /> and Placement Features</Typography>
          </Box>
        ...
        <Box className="step4">
          <Typography className='poppins' mb={2} sx={{ color: "#359CEF", fontWeight: "700", fontSize: "20px", textAlign: "center" }}>STEPS 4</Typography>
